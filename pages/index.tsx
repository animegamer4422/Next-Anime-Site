  ...
  return (
    <div className="container">
      ...
      <footer className="footer-wrapper">
        <p>Made with ❤️ and <a href="https://github.com/animegamer4422" target="_blank" rel="noopener noreferrer">
          <svg aria-hidden="true" height="24" viewBox="0 0 16 16" version="1.1" width="24" data-view-component="true" className="octicon octicon-mark-github d-block mr-2 float-left">
